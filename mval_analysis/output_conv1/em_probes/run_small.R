...
hyper_cl1B <- probes_cl1[probes_cl1$diff > 1.05,]
hypo_cl1B <- probes_cl1[probes_cl1$diff < 0.95,]
hyper_cl2B <- probes_cl2[probes_cl2$diff > 1.05,]
hypo_cl2B <- probes_cl2[probes_cl2$diff < 0.95,]
hyper_cl3B <- probes_cl3[probes_cl3$diff > 1.05,]
hypo_cl3B <- probes_cl3[probes_cl3$diff < 0.95,]
