...
RNAseq <- read_csv("trainingData.csv")
...
mx <- merge(x = new, y = RNAseq, by.x = "Name", by.y = "...1") %>%
  select(-1)
...
print("second phase, reduction of probes")
new_best <- 2
counter <- num_sim
y <- 1
...
print("third phase, reintroduction of probes")
